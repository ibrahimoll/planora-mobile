...
class _ProjectDetailScreenState extends State<ProjectDetailScreen> {
                ...
                child: TabBarView(
                  children: [
                    _tab([
                      _projectCard(),
                      _statsGrid(),
                      if (_members.isNotEmpty) _membersCard(),
                    ]),
                    _tab([_tasksCard()]),
    ...
    return _card(
      Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text('${percent.round()}% complete', style: _bold()),
              const Spacer(),
              Text('$_doneTasks/${_tasks.length} tasks', style: _muted()),
            ],
          ),
        ...
        children: [
          Row(
            children: [
              ...
              Text('AI planning brief', style: _bold()),
            ],
          ),
          const SizedBox(height: 8),
          Text(
            value.replaceFirst('AI planning brief', '').trim(),
            style: _muted(),
          ),
        ],
      ),
  ...
  Widget _scheduleCard() {
    ...
    return _section(
      ...
      p == null
          ...
          : '${p.schedulableTaskCount} schedulable task(s)',
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: ElevatedButton.icon(
                  onPressed: _applyingSchedule || p == null
                      ? null
                      : _applySchedule,
          ...
          if (p != null) ...[
            ...
            Wrap(
              ...
              children: [
                _pill(
                  'Capacity',
                  '${p.dailyCapacityHours.toStringAsFixed(1)}h/day',
                ),
                _pill('Tasks', '${p.schedulableTaskCount}/${p.totalTasks}'),
                _pill('Done', '${p.completedTaskCount}'),
              ],
            ),
            const SizedBox(height: 10),
            for (final item in p.tasks.take(5))
              _line(
                item.title,
  ...
  Widget _aiHistoryCard() => _section(
    'AI Plan History',
    _aiPlans.isEmpty
        ? 'No AI plans yet'
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(member.email ?? member.roleLabel, style: _muted()),
                    ],
                  ),
                ),
