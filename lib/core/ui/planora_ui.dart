      ...
      builder: (context, value, animatedChild) {
        return Opacity(
          ...
          child: Transform.translate(
            ...
            child: Transform.scale(scale: 0.96 + value * 0.04, child: animatedChild),
          ),
        );
      },
      child: child,
    ...
    return Row(
      children: [
        if (leading != null) ...[
          ...
          PlanoraIconButton(icon: Icons.arrow_back_rounded, tooltip: 'Back', onTap: onBack!),
          const SizedBox(width: 12),
        ],
        Expanded(
          child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        const SizedBox(width: 10),
        PlanoraIconButton(icon: Icons.search_rounded, tooltip: 'Search', onTap: onSearch),
        const SizedBox(width: 10),
        Stack(
          clipBehavior: Clip.none,
          children: [
            PlanoraIconButton(icon: Icons.notifications_none_rounded, tooltip: 'Notifications', onTap: onNotifications),
...
class PlanoraIconButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = PlanoraTheme.isDark(context);
    final resolvedBackground = backgroundColor ?? (isDark ? PlanoraTheme.darkSurface : PlanoraTheme.surface);
    final resolvedIconColor = iconColor ?? (isDark ? PlanoraTheme.darkTextPrimary : PlanoraTheme.textPrimary);
            ...
            child: AnimatedSwitcher(
              ...
              child: isLoading
                  ...
                  : Row(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        if (icon != null) ...[Icon(icon, size: 22, color: Colors.white), const SizedBox(width: 8)],
...
class PlanoraCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final decoration = BoxDecoration(
      color: gradient == null ? color ?? (isDark ? PlanoraTheme.darkSurface : PlanoraTheme.surface) : null,
      gradient: gradient,
      borderRadius: BorderRadius.circular(radius),
...
class PlanoraLoadingIndicator extends StatelessWidget {
  ...
  const PlanoraLoadingIndicator({super.key, this.size = 34, this.strokeWidth = 2.7, this.color});
...
class PlanoraBrandLoader extends StatefulWidget {
  ...
  const PlanoraBrandLoader({super.key, this.message = 'Loading...', this.size = 88, this.showMessage = true});

  @override
  State<PlanoraBrandLoader> createState() => _PlanoraBrandLoaderState();
}

class _PlanoraBrandLoaderState extends State<PlanoraBrandLoader> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        final pulse = 0.988 + (math.sin(_controller.value * math.pi * 2) * 0.018);
        return Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Transform.scale(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset('assets/images/planora_logo.png', fit: BoxFit.cover),
                      ),
                    ),
                  ],
                ),
...
class PlanoraSegmentedTabs extends StatelessWidget {
  ...
  const PlanoraSegmentedTabs({super.key, required this.tabs, required this.selectedIndex, required this.onChanged});
              ...
              child: AnimatedContainer(
                ...
                child: Text(
                  ...
                  style: Theme.of(context).textTheme.labelMedium?.copyWith(
                        fontWeight: FontWeight.w900,
                        color: selected ? Theme.of(context).colorScheme.primary : isDark ? PlanoraTheme.darkTextSecondary : PlanoraTheme.textSecondary,
                      ),
                ),
              ),
            ),
...
class PlanoraRingProgress extends StatelessWidget {
  ...
  const PlanoraRingProgress({super.key, required this.progress, required this.centerText, required this.label, this.size = 112});
...
class _PlanoraRingPainter extends CustomPainter {
  ...
  const _PlanoraRingPainter({required this.progress, required this.color, required this.backgroundColor});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(Rect.fromCircle(center: center, radius: radius), -math.pi / 2, progress * math.pi * 2, false, foregroundPaint);
  }
